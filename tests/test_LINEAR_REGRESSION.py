...
synth_patterns_cols = ['"lin regr 1a" AND "lin regr 1b" AND "lin regr 1c" AND "lin regr 2"']
synth_exceptions_cols = ['"lin regr 1d" AND "lin regr 1e" AND "lin regr 1f" AND "lin regr 3"']
...
def test_real():
    ...
    res["vehicle"] = (
        ['"SCALED_VARIANCE_MINOR" AND "SCATTER_RATIO"', '"SCATTER_RATIO" AND "SCALED_VARIANCE_MINOR"'],
        [],
    )
