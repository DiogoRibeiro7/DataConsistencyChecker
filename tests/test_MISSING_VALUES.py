...
def test_synthetic_one_row_nulls():
    synth_test(test_id, "one-row", [], ["missing vals all", "missing vals most", "missing vals most null"])


@requires_synthetic_nones
def test_synthetic_in_sync_nulls():
    synth_test(test_id, "in-sync", [], ["missing vals most null"])  # Mostly NUll, with some non-null


@requires_synthetic_nones
def test_synthetic_random_nulls():
    synth_test(test_id, "random", [], ["missing vals most null"])


@requires_synthetic_nones
def test_synthetic_80_percent_nulls():
    synth_test(test_id, "80-percent", [], ["missing vals most null"])


@requires_synthetic_all_columns
def test_synthetic_all_cols_no_nulls():
    synth_test_all_cols(test_id, "none", ["missing vals all"], ["missing vals most", "missing vals most null"])


@requires_synthetic_all_columns
def test_synthetic_all_cols_one_row_nulls():
    synth_test_all_cols(test_id, "one-row", [], ["missing vals all", "missing vals most", "missing vals most null"])


@requires_synthetic_all_columns
def test_synthetic_all_cols_in_sync_nulls():
    synth_test_all_cols(test_id, "in-sync", [], ["missing vals most null"])  # Mostly NUll, with some non-null


@requires_synthetic_all_columns
def test_synthetic_all_cols_random_nulls():
    synth_test_all_cols(test_id, "random", [], ["missing vals most null"])


@requires_synthetic_all_columns
def test_synthetic_all_cols_80_percent_nulls():
    synth_test_all_cols(test_id, "80-percent", [], ["missing vals most null"])
