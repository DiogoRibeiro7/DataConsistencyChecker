...
def get_date_tests(checker):
    ...
    return {
        ...
        'EARLY_DATES': (
            ...
            checker._DataConsistencyChecker__check_early_dates,
            checker._DataConsistencyChecker__generate_early_dates,
            True, True, True, False
        ),
        'LATE_DATES': (
            '',
            'Check for dates significantly later than the other dates in the column.',
            checker._DataConsistencyChecker__check_late_dates,
            checker._DataConsistencyChecker__generate_late_dates,
            True, True, True, False
        ),
        'UNUSUAL_DAY_OF_WEEK': (
            '',
            'Check if a date column contains any unusual days of the week.',
            checker._DataConsistencyChecker__check_unusual_dow,
            checker._DataConsistencyChecker__generate_unusual_dow,
            True, True, True, False
        ),
        'UNUSUAL_DAY_OF_MONTH': (
            '',
            'Check if a date column contains any unusual days of the month.',
            checker._DataConsistencyChecker__check_unusual_dom,
            checker._DataConsistencyChecker__generate_unusual_dom,
            True, True, True, False
        ),
        'UNUSUAL_MONTH': (
            '',
            'Check if a date column contains any unusual months of the year.',
            checker._DataConsistencyChecker__check_unusual_month,
            checker._DataConsistencyChecker__generate_unusual_month,
            True, True, True, False
        ),
        'UNUSUAL_HOUR': (
            ...
            checker._DataConsistencyChecker__check_unusual_hour,
            checker._DataConsistencyChecker__generate_unusual_hour,
            True, True, True, False
        ),
        'UNUSUAL_MINUTES': (
            ...
            ('Check if a datetime / time column contains any unusual minutes of the hour. '
             'This and UNUSUAL_MINUTES also identify where it is inconsistent if the time '
             'is included in the column.'),
            checker._DataConsistencyChecker__check_unusual_minutes,
            checker._DataConsistencyChecker__generate_unusual_minutes,
            True, True, True, False
        ),
        'CONSTANT_DOM': (
            ...
            checker._DataConsistencyChecker__check_constant_dom,
            checker._DataConsistencyChecker__generate_constant_dom,
            True, True, True, False
        ),
        'CONSTANT_LAST_DOM': (
            ...
            checker._DataConsistencyChecker__check_last_dom,
            checker._DataConsistencyChecker__generate_last_dom,
            True, True, True, False
        ),
        ...
        'CONSTANT_GAP': (
            ...
            checker._DataConsistencyChecker__check_constant_date_gap,
            checker._DataConsistencyChecker__generate_constant_date_gap,
            True, True, False, False
        ),
        'LARGE_GAP': (
            'Check for large gaps between dates.',
            ('Check if there is an unusually large gap in time between dates in two date columns.'),
            checker._DataConsistencyChecker__check_large_date_gap,
            checker._DataConsistencyChecker__generate_large_date_gap,
            True, True, False, False
        ),
        'SMALL_GAP': (
            'Check for small gaps between dates.',
            ('Check if there is an unusually small gap in time between dates in two date columns.'),
            checker._DataConsistencyChecker__check_small_date_gap,
            checker._DataConsistencyChecker__generate_small_date_gap,
            True, True, False, False
        ),
        'LATER': (
            '',
            'Check if one date column is consistently later than another date column.',
            checker._DataConsistencyChecker__check_date_later,
            checker._DataConsistencyChecker__generate_date_later,
            True, True, False, False
        ),
        'SAME_DATE': (
            ...
            ('Check if two date columns consistently contain the same date, but may have '
             'different times.'),
            checker._DataConsistencyChecker__check_same_date,
            checker._DataConsistencyChecker__generate_same_date,
            True, True, False, False
        ),
        'SAME_MONTH': (
            ...
            checker._DataConsistencyChecker__check_same_month,
            checker._DataConsistencyChecker__generate_same_month,
            True, True, False, False
        ),
        'CORRELATED_DATES': (
            '',
            'Check if two date columns are correlated',
            checker._DataConsistencyChecker__check_correlated_dates,
            checker._DataConsistencyChecker__generate_correlated_dates,
            True, True, False, False
        ),
        ...
        'LARGE_GIVEN_DATE': (
            ...
            checker._DataConsistencyChecker__check_large_given_date,
            checker._DataConsistencyChecker__generate_large_given_date,
            True, True, False, False
        ),
        'SMALL_GIVEN_DATE': (
            ...
            checker._DataConsistencyChecker__check_small_given_date,
            checker._DataConsistencyChecker__generate_small_given_date,
            True, True, False, False
        ),
    }
